...
int main(void)
{
	...
	printf("=====================================================\n");
	if(db_store(db, "asdf", "fjjj", DB_INSERT) != 0)
		err_quit("db_store error for asdf");
	printf("=====================================================\n");
	if(db_store(db, "fjkl", "asdfffklejkl;", DB_INSERT) != 0)
		err_quit("db_store error for fjkl");
	printf("=====================================================\n");
	if(db_store(db, "asdf", "123456j", DB_STORE) != 0)
		err_quit("db_store error for asdf");
	printf("=====================================================\n");
	if(db_store(db, "fjkl", "jjkkllmm", DB_STORE) != 0)
		err_quit("db_store error for fjkl");
	printf("=====================================================\n");
	db_store(db, "xuyz", "asdfffklejrk;", DB_INSERT);
	printf("=====================================================\n");
